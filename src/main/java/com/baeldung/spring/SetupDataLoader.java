...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(final ContextRefreshedEvent event) {
        ...
        final Privilege managerPrivilege = createPrivilegeIfNotFound("MANAGEMENT_PRIVILEGE");
		...
		final Role managerRole = createRoleIfNotFound("ROLE_MANAGER", Arrays.asList(readPrivilege, managerPrivilege));

        // == create initial user
        createUserIfNotFound("test@test.com", "Test", "Test", "test", new ArrayList<>(Arrays.asList(adminRole)));

        // == create manager user
        createUserIfNotFound("manager@manager.com", "First Name", "Last Name", "manager", new ArrayList<>(Arrays.asList(managerRole)));
